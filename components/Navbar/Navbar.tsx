...
export default function Navbar() {
  return (
    <div className="sticky top-0 z-50 flex w-full flex-row items-center justify-between border-b-[1px] border-solid border-on-primary px-[1.25rem] pb-[1.25rem] pt-[0.875rem] backdrop-blur-[6px]">
      <Breadcrumbs />
