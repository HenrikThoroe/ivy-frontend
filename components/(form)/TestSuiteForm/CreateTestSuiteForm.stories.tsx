...
const meta: Meta<typeof CreateTestSuiteForm> = {
  tags: ['autodocs'],
  title: 'Components/Form/Create Test Suite',
  component: CreateTestSuiteForm,
}

type Story = StoryObj<typeof CreateTestSuiteForm>
